...
public class Main {
    ...
    */
    ...
    static class Generics<T> {
        ...
        */
        ...
        // 사용법
        static <S, T extends S> boolean copyList(List<S> targetList, List<T> addList) {
            return targetList.addAll(addList);
        }
    }
    /* 위의 사용 예
    public static void main(String[] args) {
    ...
    */
    ...
    private static void printMe (List<?> numbers) {
        //numbers.forEach(s -> System.out.println(s));
        //numbers.add(new Object());
    }
    private static void printMe2 (List<? extends Number> numbers) {
        //numbers.forEach(s -> System.out.println(s));
    }
